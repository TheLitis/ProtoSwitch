...
**ProtoSwitch v0.2.0-beta.6** — terminal-first утилита для Telegram Desktop, которая следит за состоянием proxy, подбирает замену из бесплатных MTProto/SOCKS5-источников и записывает managed proxy в настройки Telegram без popup и без focus stealing.
...
- `manual` — legacy-режим в конфиге, в beta.6 пользовательские команды всё равно не открывают окно подтверждения Telegram.
