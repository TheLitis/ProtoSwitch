...
## Что Должно Попасть В `v0.2.0-beta.6`
...
5. Прогоните portable smoke:
   `powershell -NoProfile -ExecutionPolicy Bypass -File scripts\smoke-portable.ps1 -Version 0.2.0-beta.6`
...
9. Linux/macOS portable smoke идёт через CI-скрипт:
   `python3 scripts/smoke-unix.py --repo-root <repo> --version 0.2.0-beta.6 --platform linux --arch x64`

## Основной Путь Публикации

1. Закоммитьте релизные изменения.
2. Создайте подписанный тег `v0.2.0-beta.6`.
