...
- CI и release workflows переведены на актуальные `actions/upload-artifact@v7` и `actions/download-artifact@v8`, чтобы убрать Node.js runtime-аннотацию без workaround env.
